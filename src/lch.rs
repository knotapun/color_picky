// /*
// Move the mouse left or right (While holding the mouse button down) to change the luminosity of the colors displayed.


// LCH is a preceptual color space, represented by the following:
// L - Luminosity    - How bright a color is.
// C - Chroma        - How intensely colored a color is.
// H - Hue           - Whoa, that's a hard word to define. Shade? What percentage of red, blue, and green for the chroma component?


// The mouse controls the luminosity axis, meaning that brighter colors are farther to the right.
// The X axis is the Chroma axis, the further up you go, the more strongly colored the pixels are.
// The Y axis controls the hue.


// A color space is a numerical representation of colors.
// For computers, that's commonly sRGB where you have red, green, and blue between 0 and 255.
// For paint, you might think pantone colors. 

// A preceptual color space is a color space where the numbers are intented to map onto the average human's experience of colors.
// This means that two colors with the same or similar luminosity will appear to a human of average sight,
// to appear to be just as bright, regardless of chroma or hue. Similarly, a color of similar chroma will appear just as intense as
// each other.
// */
